...
function ParseModelData(Bigdata) {
    ...
    for (var i = 1; i <= UniCount; i++) {
        ...
        const PersonalityUni = UniInfo.filter((x) => (!(typeof x[0] === 'undefined') && PersonalityList.includes(x[0])));
